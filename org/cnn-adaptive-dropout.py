...
image_size = 32
n_classes = 10
keep_prob1_value, keep_prob2_value = 1.0, 1.0
hidden_1 = 256
hidden_2 = 128
depth_1 = 16
depth_2 = 32
...
def cnn(x):
    ...
    y_conv = tf.matmul(fc5_dropout, weights["layer6"]) + biases["layer6"]

    return y_conv, keep_prob1, keep_prob2


# Build the graph for the deep net
y_conv, keep_prob1, keep_prob2 = cnn(X)
...
with tf.Session() as sess:
    ...
    for i in range(iterations):
        ...
        if (i + 1) % display_step == 0 or i == 0:
            ...
            keep_prob2_vals.append(keep_prob2_vals)

            if _cost_validation / _cost_test > 30:
                keep_prob1_value /= 2
                keep_prob1_value /= 1.5
            elif _cost_validation / _cost_test < 3 and np.max([keep_prob1_value, keep_prob2_value]) < 1:
                keep_prob1_value *= 2
                keep_prob1_value *= 1.5
    ...
    plt.legend([keep_prob1_legend, keep_prob2_legend], [r'$kp_1$', r'$kp_2$'])
    plt.show()
